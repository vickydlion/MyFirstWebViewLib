//
//  MyFirstWebViewLib.swift
//  MyFirstWebViewLib
//
//  Created by Vivek Garg on 25/06/21.
//

import UIKit
import WebKit

open class MyFirstWebViewLib: UIViewController, WKNavigationDelegate, WKUIDelegate {
    ...
    private let webView: WKWebView = {
        ...
        configurations.preferences.setValue(true, forKey: "developerExtrasEnabled")
